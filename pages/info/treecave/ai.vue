<template>
	<view class="container">
			<u-navbar class="wrap" height=60 title="远方来客" title-size=40 :background="background" is-back=true
...
<style>
	.container {
	  ...
	  height: 100vh;
	  background:  linear-gradient(60deg, #42c5a4,#93dcbe,#8adbba);;
	}
	.wrap {
		display: flex;
		/* 使用 flex 布局 */
	...
	button {
	  padding: 1px 20px; /* 调整按钮的内边距来改变大小 */
	   ...
	   background: linear-gradient(45deg, #3c8aff, #58bfff,#8accf4); /* 设置渐变背景 */
	   color: #fff;
	   cursor: pointer;
	   margin-left: 10px;
	   margin-bottom: 10px;
